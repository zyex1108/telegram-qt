...
QString CTelegramMediaModule::getPictureToken(const T *peerData, const Telegram::PeerPictureSize size) const
{
    ...
    return QString(QLatin1String("%1%2%3"))
            .arg(picture.dcId, sizeof(picture.dcId) * 2, 16, QLatin1Char('0'))
            .arg(picture.volumeId, sizeof(picture.dcId) * 2, 16, QLatin1Char('0'))
            .arg(picture.localId, sizeof(picture.dcId) * 2, 16, QLatin1Char('0'));
}
